...
# 5-step smoke test (step checkpoint + short val decode)
MAX_STEPS=5 SAVE_EVERY_STEPS=5 VAL_EVERY_STEPS=5 VAL_MAX_UTTERANCES=2 \
  CHECKPOINT_BASENAME=adapter_asr_align_vicuna_smoke \
  WANDB_ENABLED=false \
  uv run training/adapter_asr_align_vicuna_trainer.py
```
